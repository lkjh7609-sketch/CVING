    ...
    <div className="bg-white rounded-xl border border-zinc-200 shadow-[0_1px_3px_rgba(0,0,0,0.02)] transition-all hover:border-zinc-300 overflow-hidden">
      ...
      <div className="p-3.5 sm:p-4 bg-zinc-50/60 border-b border-zinc-200/80 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          {isReady ? (
            <span className="inline-flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-[11px] font-medium text-emerald-700 bg-emerald-50 px-1.5 sm:px-2.5 py-0.5 rounded-full border border-emerald-200">
              <CheckCircle2 className="w-3 h-3 shrink-0" />
              <span className="hidden sm:inline">공고 준비됨</span>
              <span className="sm:hidden">준비됨</span>
            </span>
          ) : (
            <span className="inline-flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-[11px] font-normal text-amber-700 bg-amber-50 px-1.5 sm:px-2.5 py-0.5 rounded-full border border-amber-200">
              <AlertCircle className="w-3 h-3 shrink-0" />
              <span className="hidden sm:inline">공고 입력 필요</span>
              <span className="sm:hidden">미입력</span>
            </span>
          )}
          ...
          <button
            ...
            className="p-2 sm:p-1.5 text-zinc-400 hover:text-zinc-600 rounded-lg hover:bg-zinc-100 active:bg-zinc-200 transition-colors"
          ...
          <button
            ...
            className="p-2 sm:p-1.5 text-zinc-400 hover:text-rose-600 rounded-lg hover:bg-rose-50 active:bg-rose-100 transition-colors"
            title="회사 삭제"
          >
