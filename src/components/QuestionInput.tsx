      ...
      <div className="p-3.5 sm:p-4 bg-zinc-50/60 border-b border-zinc-200/80">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 mb-1">
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <input
                    ...
                    className="w-20 sm:w-24 px-2 py-1.5 text-xs sm:text-sm border border-zinc-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-zinc-900 focus:border-zinc-900 font-mono"
                    min={100}
                    max={5000}
                    step={100}
                  />
                  <button
                    ...
                    className="px-2.5 sm:px-3 py-1.5 text-xs bg-zinc-900 text-white font-medium rounded-lg hover:bg-zinc-800 transition-colors"
                  >
                    저장
                  </button>
                  <button
                    ...
                    className="px-2 sm:px-2.5 py-1.5 text-xs bg-zinc-100 text-zinc-700 rounded-lg hover:bg-zinc-200 transition-colors"
                  >
                    취소
                  </button>
                </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0 self-start sm:self-auto">
            {isCompleted ? (
              <span className="inline-flex items-center gap-1.5 px-2 sm:px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-emerald-50 text-emerald-700 border border-emerald-200">
                <CheckCircle2 className="w-3.5 h-3.5" /> 작성 완료
              </span>
            ) : isStarted ? (
              <span className="inline-flex items-center gap-1.5 px-2 sm:px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-zinc-100 text-zinc-700 border border-zinc-200">
                <Circle className="w-3 h-3 fill-zinc-400 text-zinc-400" /> 작성 중
              </span>
            ) : (
              <span className="inline-flex items-center gap-1 px-2 sm:px-2.5 py-0.5 rounded-full text-[11px] font-normal bg-zinc-50 text-zinc-400 border border-zinc-200/70">
                미작성
              </span>
            )}
          </div>
