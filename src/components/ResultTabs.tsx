...
export const ResultTabs: React.FC = () => {
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 bg-white p-4 sm:p-5 rounded-2xl border border-zinc-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
        <div>
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-zinc-900 tracking-tight">생성 결과 관리 및 내보내기</h2>
          </div>
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-white bg-zinc-900 hover:bg-zinc-800 disabled:bg-zinc-200 disabled:text-zinc-400 disabled:cursor-not-allowed rounded-lg transition-all shadow-2xs"
      ...
      <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.02)] overflow-hidden flex flex-col min-h-[420px] sm:min-h-[500px]">
        {/* Company Tabs Bar */}
        <div className="flex items-center gap-1 sm:gap-1.5 px-3 sm:px-4 pt-2.5 sm:pt-3 bg-zinc-50/60 border-b border-zinc-200 overflow-x-auto">
          {companies.length === 0 ? (
        ...
        {activeCompany ? (
          <div className="flex-1 flex flex-col">
            ...
            <div className="p-3 sm:p-4 border-b border-zinc-100 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
              <div>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                {/* Character Count */}
                {currentContent && (
                  <span className="text-xs text-zinc-600 font-mono px-2 sm:px-2.5 py-1 bg-zinc-100 rounded-lg border border-zinc-200/50">
                ...
                {activeResult?.status === 'generating' || isBatchGenerating ? (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-semibold text-white bg-rose-600 hover:bg-rose-700 rounded-lg shadow-2xs transition-all"
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-medium text-zinc-700 bg-zinc-100 hover:bg-zinc-200 disabled:opacity-50 rounded-lg transition-colors border border-zinc-200/60"
                ...
                <button
                  ...
                  onClick={handleCopy}
                  className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-medium text-zinc-800 bg-zinc-100 hover:bg-zinc-200 disabled:opacity-40 disabled:cursor-not-allowed rounded-lg transition-colors border border-zinc-200/80"
                >
                  {copied ? (
                    <>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2 sm:px-2.5 py-1.5 text-xs font-medium text-zinc-600 hover:text-zinc-900 bg-zinc-50 hover:bg-zinc-100 disabled:opacity-40 rounded-lg transition-colors border border-zinc-200"
